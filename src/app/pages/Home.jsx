      ...
      <div className="bg-gray-50 py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">PaymentLens is helping professionals get paid on time</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-700 mb-6">
                "PaymentLens helped me avoid a client with a history of late payments. This tool is essential for any freelancer who wants to maintain healthy cash flow."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold">JD</div>
                <div className="ml-4">
                  <div className="font-medium text-gray-900">James Doe</div>
                  <div className="text-sm text-gray-500">Web Developer</div>
                </div>
              </div>
            </div>
            
            <div className="bg-white p-8 rounded-2xl shadow-lg md:translate-y-4">
              <div className="flex items-center mb-4">
                <div className="text-yellow-400 flex">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="text-gray-700 mb-6">
                "I've adjusted my payment terms with clients based on PaymentLens data and have seen a 40% reduction in late payments. This is a game-changer!"
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold">SJ</div>
                <div className="ml-4">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-700 mb-6">
                "As an agency owner, PaymentLens has become an essential part of our client vetting process. We can now focus on clients who value our work."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold">MT</div>
                <div className="ml-4">
